...
# System Variables
# --------------------------------------
VIRTUALENV_PATH="/usr/local/share/projects/WritingObserver/VirtualENVs/WOvenv2"
#VIRTUALENV_PYTHON="/usr/local/share/Projects/WritingObserver/VirtualENVs/learning_observer/bin/python3.9"
LANGTOOL_LOC="/usr/local/share/projects/WritingObserver/Repositories2/AWE_LanguageTool/"
LOGFILE_DEST="/usr/local/share/projects/WritingObserver/Repositories2/ArgLab_writing_observer/learning_observer/learning_observer/logs"
